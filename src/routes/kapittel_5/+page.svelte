<script>
	...
	const oppgaver = [
		[
			{ nr: "5.01", navn: "Grunnstoff" },
			{ nr: "5.02", navn: "Tre små kineser" },
			{ nr: "5.03", navn: "Adjektivhistorie" },
		],
		[
			{ nr: "5.04", navn: "Geometri" },
			{ nr: "5.05", navn: "Telefonnummer" },
			{ nr: "5.06", navn: "Konstanter" },
